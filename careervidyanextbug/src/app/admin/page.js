      ...
      {!liveStats ? (
        ...
        <>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-4">
            ...
            <LiveCard icon={<Users size={16} />} label="Today's Visitors" value={liveStats.todayVisitors} accent="bg-blue-500" />
            <LiveCard icon={<UserCheck size={16} />} label="Today's Leads" value={liveStats.todayLeads} accent="bg-blue-500" />
          ...
          {liveStats.trafficSources?.length > 0 && (
            <div className="bg-white p-4 rounded-lg shadow-lg mb-6">
              <h2 className="font-semibold mb-3 text-sm">Today's Traffic Sources</h2>
