              ...
              <SwiperSlide key={member._id ?? idx}>
                ...
                >
                  ...
                  >
                    ...
                    <button
                      className="mt-1.1 bg-[#000a1f] text-white text-[10px] md:text-xs px-3 py-[3px] 
...
//   return (
//     <section className="relative w-full bg-[#000a1f] py-16 md:py-20 overflow-hidden">
//       <h2 className="text-center text-3xl md:text-4xl font-bold text-white mb-10 md:mb-14">
//         Meet Our Expert Team
//       </h2>
...
//                   <div
//                     className="absolute bottom-3 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-md 
//                      rounded-xl px-3 py-2 text-center shadow-md w-[88%]"
//                     onClick={(e) => e.stopPropagation()}
//                   >
//                     <h3 className="text-sm md:text-base font-semibold text-gray-900 truncate">
//                       {member.name}
...
//                        rounded-full hover:bg-[#00143d] transition-all"
//                       onClick={() =>
//                         (window.location.href = `/teamexpand?id=${member._id}`)
//                       }
//                     >
...
//            bg-white text-[#000a1f] rounded-full w-10 h-10 sm:w-12 sm:h-12 flex 
//            items-center justify-center shadow-lg hover:scale-105 transition-all"
//         >
