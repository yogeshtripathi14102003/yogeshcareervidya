        ...
        <section className="max-w-7xl mx-auto px-6 py-12">
          <div className="border-l-4 border-amber-500 bg-white p-6 rounded-r-xl border-y border-r border-slate-200 shadow-sm">
            <p className="text-slate-700 text-base md:text-lg leading-relaxed font-medium">
              ...
              designed to help individuals pursue higher education while continuing to meet their
              existing professional responsibilities. It provides an opportunity to enhance
              knowledge, develop new skills, improve academic qualifications, and stay competitive
              in today's evolving professional environment. With flexible learning options,
              working professionals can continue their education without having to leave their
        ...
        <section className="max-w-7xl mx-auto px-6 pb-16 grid md:grid-cols-2 gap-6">
          <div className="border-t-4 border-[#D4A72C] bg-white border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              ...
              structured partnerships and Memorandums of Understanding (MoUs). These
              collaborations help create opportunities for employee training, professional
              development, skill enhancement, and continuing education, enabling working
