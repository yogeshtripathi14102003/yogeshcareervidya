...
const FloatingSelect = ({ label, name, value, onChange, options = [] }) => (
  <div className="relative w-full">
    ...
    <select
      ...
      value={value}
      onChange={onChange}
      className="w-full rounded-md border border-[#05347f] px-3 py-2  text-[#05347f]  text-[13px]"
    >
...
const Signup = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <button onClick={onClose} className="absolute top-3 right-3 text-[#05347f] cursor-pointer">
          <X />
        </button>
  ...
  />
        ...
        <p className="text-center text-xs text-[#05347f]  mt-3">
