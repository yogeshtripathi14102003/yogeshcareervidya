...
async function getTeam() {
  ...
  // Resolve image URLs on the server — client component ko BASE_URL
...
// ⚠️ IMPORTANT: is file ke top pe "use client" NAHI hona chahiye.
// Ye Server Component hai, isliye async allowed hai.
export default async function TeamSection() {
  const team = await getTeam();
  return <TeamSliderClient team={team} />;
}