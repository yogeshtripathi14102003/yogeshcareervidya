...
export default function OfferAppliedStudents({ onClose }) {
  ...
  const downloadExcel = () => {
    ...
    const excelData = filteredStudents.map((s) => ({
      ...
      State: s.state || "-",
      Address: s.addresses || "-",
      "Offer Type": getOfferType(s.subsidyCoupon),
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-4 flex flex-wrap items-center gap-4">
              <div>
                <label htmlFor="offerFilter" className="mr-2 font-semibold text-sm">
                  Filter by Offer:
                </label>
                <select
                  id="offerFilter"
                  ...
                  {filteredStudents.length === 0 ? (
                    ...
                    filteredStudents.map((student) => (
                      <tr key={student._id} className="hover:bg-gray-50 border-t">
                        ...
                        <td className="border p-2 font-semibold text-green-600 whitespace-nowrap">
                          {getOfferType(student.subsidyCoupon)} (
                          {student.subsidyCoupon})
                        </td>
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                ...
                <p>
                  <strong>Offer:</strong>{" "}
                  {getOfferType(viewStudent.subsidyCoupon)} (
