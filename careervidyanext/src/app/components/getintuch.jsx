...
export default function ContactUsPage() {
  ...
  return (
    <div className=" bg-gradient-to-b from-blue-50 to-blue-100 py-16 px-6">
      <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-10 border-2 border-[#c15304]">
        {/* Header */}
        <h1 className="text-3xl font-semibold text-center text-[#0056A4] mb-6">
          Let’s Discuss Your Future!
        </h1>
  ...
  <button
    type="submit"
    disabled={loading}
    className={`w-full bg-[#c15304] border-2 border-[#c15304] text-white py-3 rounded-lg transition-all ${
      loading ? "opacity-60 cursor-not-allowed" : "hover:bg-[#c15304]"
    }`}
  >
    {loading ? "Submitting..." : "Submit"}
