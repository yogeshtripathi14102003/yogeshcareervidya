...
>
  ...
  {/* NEW: 3-Column Divided Programme Strip */}
  <div className="relative flex justify-center items-stretch mt-10 max-w-2xl mx-auto rounded-2xl overflow-hidden border border-white/10 bg-white/[0.04] backdrop-blur-md shadow-[0_0_30px_rgba(212,167,44,0.1)]">
    {[ "B. Tech", "M. Tech", "Diploma"].map((p, i) => (
      <div
        key={p}
        className={`group relative flex-1 px-4 py-6 md:py-7 hover:bg-[#D4A72C]/10 transition-all duration-300 ${
          i !== 0 ? "border-l border-white/10" : ""
        }`}
      >
        <p className="text-white font-[Fraunces,serif] text-lg md:text-xl font-bold tracking-wide group-hover:text-[#D4A72C] transition-colors">
          {p}
        </p>
        <span className="block w-6 h-[2px] bg-[#D4A72C]/50 mx-auto mt-2 group-hover:w-10 transition-all duration-300" />
      </div>
    ))}
  </div>
</section>
