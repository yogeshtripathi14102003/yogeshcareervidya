    ...
    return (
        <section className="mt-12 w-full flex justify-center py-10 bg-gray-50">
            ...
            <div className="w-full max-w-[1600px] px-4">
                ...
                {/* ✅ SEO FIX: added a section-level H2. Every sibling section
                    component (Offerdcourse, OnlineCourseEligibility,
                    JobOpportunities, CourseWorthIt) opens with its own H2,
                    but this one jumped straight to H3 with nothing above it.
                    Since the sections above this one on the page are all
                    conditionally rendered depending on the course's data,
                    there's no guarantee an H2 exists right before this
                    component's H3s — this keeps the hierarchy correct
                    regardless of what renders above it. */}
