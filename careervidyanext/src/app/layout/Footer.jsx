...
//                <li><Link href="/Counslerlogin" className="hover:text-white transition">Counselors Login</Link></li>
...
export default function Footer() {
  ...
  if (!mounted) {
    return (
      <footer className="bg-[#000d2d] min-h-[200px]">
        &nbsp;
      </footer>
    );
  }
  ...
  const socials = [
    {
      name: "WhatsApp",
      url: "https://wa.me/9289716667",
      img: "/images/whatshap.png",
    },
    {
      name: "LinkedIn",
  ...
  return (
    <footer className="bg-[#000d2d] text-white pt-16 pb-8 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* =========================================
            TOP ROW: OFFICES + QUICK LINKS + NEWSLETTER
        ========================================== */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            {/* HEAD OFFICE */}
            <div>
              <h3 className="text-lg font-bold mb-4 border-b border-gray-600 pb-2 inline-block w-full">
                Head Office (Noida)
              </h3>
          ...
          ====================================== */}
          <div>
            <h3 className="text-lg font-bold mb-4 border-b border-gray-200 pb-2 inline-block w-full">
              Quick Links
            </h3>
        ...
        <div className="border-t border-gray-800 pt-10 text-center">
          ...
          <h4 className="text-[#c15304] font-bold mb-3 text-base">
            Disclaimer
          </h4>

          <p className="text-xs text-gray-200 max-w-3xl mx-auto leading-relaxed">
            Career Vidya Edu-Tech Pvt. Ltd. provides unbiased educational
            and career guidance for informational purposes only. We do not
            guarantee admissions, placements, or job outcomes. Users should
            verify course, fee, and institution details independently.
            Career Vidya is not liable for any loss or reliance on website
            content or third-party links.
          </p>
