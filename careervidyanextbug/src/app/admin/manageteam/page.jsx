    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "40px" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "1.1rem" }}>
          Manage your high-performing team members and roles effortlessly.
        </p>
      </div>
        ...
        >
          <span
            style={{
              ...
              width: "8px",
              height: "18px",
              background: editId ? "#3b82f6" : "#10b981",
              borderRadius: "4px",
            }}
          ></span>
        ...
        >
          ...
          <div style={{ gridColumn: "span 2" }}>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows="3"
              placeholder="Briefly describe their role or responsibilities..."
              style={{
                width: "100%",
                padding: "11px 14px",
                border: "1px solid #d1d5db",
      ...
      >
        <h2 style={{ fontSize: "1.6rem", fontWeight: "700", color: "#111827" }}>
          Active Members ({teamList.length})
        </h2>
      </div>
