...
export default function CourseDetailClient({ course }) {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        {/* SEO: page ka primary H1 — visually hidden, sirf ek baar,
            guaranteed render hota hai chahe Detailsignup skip ho ya na ho.
            Design mein visually chahiye to className ko neeche wale
            styled version se replace kar dena. */}
