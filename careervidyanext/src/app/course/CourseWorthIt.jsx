    ...
    <section className="w-full flex justify-center py-12 bg-white font-sans">
      ...
      <div className="w-full max-w-[1600px] px-4 md:px-10">
        ...
        <div className="space-y-6">
          ...
          {/* Image BELOW points */}
          {/* ✅ SEO FIX: was a plain <img> with no width/height (CLS risk,
              same reasoning as CourseOverview.jsx). Switched to next/image
              with `fill` inside a sized, relatively-positioned wrapper. The
              onError fallback behavior is preserved. */}
          {image?.url && (
            <div className="relative w-full h-[350px] md:h-[450px] mt-12 rounded-2xl shadow-lg border border-gray-100 bg-white overflow-hidden">
              <Image
                src={image.url}
                alt={courseTitle || "Course Illustration"}
                fill
