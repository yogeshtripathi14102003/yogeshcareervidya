...
// //   return (
// //     <header className="w-full bg-white border-b-[3px] border-red-600">
...
// //             <Image
// //               src="/images/LogoUpdated1.png" // 🔁 Replace with your image path or remote URL
// //               alt="CU Online Logo"
// //               fill
...
// //           {/* Text beside logo */}
// //           <div>
// //             <h1 className="text-2xl font-bold text-[#e30613] flex items-center">
// //               CU <span className="text-gray-900 ml-1">Online</span>
// //             </h1>
