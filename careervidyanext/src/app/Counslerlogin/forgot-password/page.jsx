...
//             <h1 className="text-3xl font-bold text-[#1a2470]">Forgot Password</h1>
...
//                 className="w-full text-white py-3 rounded-lg font-semibold tracking-wide flex justify-center items-center gap-2 transition"
...
// Icons positioned surrounding the central India map graphics matching the reference design
const leftIcons = [
    ...
    >
      ...
      <div className="absolute top-1/2 left-[25%] -translate-x-1/2 -translate-y-1/2 w-[240px] h-[300px] pointer-events-none opacity-90 flex items-center justify-center">
        <svg viewBox="0 0 200 240" className="w-full h-full">
          <defs>
            <pattern id="dot-pattern-forgot-logo" x="0" y="0" width="7" height="7" patternUnits="userSpaceOnUse">
              <circle cx="2.5" cy="2.5" r="1.8" fill="#00d2ff" />
            </pattern>
          </defs>
          <path
            fill="url(#dot-pattern-forgot-logo)"
      ...
      <div className="w-full md:w-[38%] lg:w-[35%] flex items-center justify-center p-6 bg-white z-10">
        <div className="w-full max-w-[350px] bg-white rounded-lg shadow-[0_10px_30px_rgba(0,0,0,0.18)] border border-gray-100 p-8">
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-[#1a1c6e] tracking-tight">Forgot Password</h1>
          ...
          {sent ? (
            <div className="space-y-4">
              <div className="bg-green-50 text-green-700 p-3 rounded border border-green-200 flex gap-2 items-start text-xs font-medium">
              ...
              <button
                onClick={() => router.push(`/Counslerlogin/reset-password?email=${encodeURIComponent(email)}`)}
                className="w-full bg-[#1c1d73] hover:bg-[#121352] text-white py-2.5 rounded-none font-semibold text-xs transition-colors flex items-center justify-center gap-1 shadow-sm"
              >
                Enter Code <ArrowRight size={15} />
              </button>
            </div>
          ) : (
          ...
          <div className="text-center mt-6 space-y-2">
            <div>
              <Link
                href="/Counslerlogin"
                className="text-xs text-gray-600 hover:text-[#1c1d73] font-medium inline-flex items-center gap-1 transition-colors"
              >
