        ...
        <section className="w-full flex justify-center py-12 bg-white font-sans">
            <div className="w-full max-w-6xl px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                    ...
                    {/* Left Side: Topics List (Spans 8 columns) */}
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="text-left">
                                        <h3 className="text-lg md:text-xl font-bold text-[#002147] mb-2">
                                            {topic.subHeading || `Key Highlight ${index + 1}`}
                                        </h3>
                                        {topic.description && (
                    ...
                    {/* Right Side: Image (Spans 4 columns) */}
                    {image?.url && (
                        <div className="lg:col-span-4 w-full order-first lg:order-last mb-8 lg:mb-0">
                            <div className="sticky top-10">
                                <img
                                    src={image.url}
                                    alt="Course Worth Illustration"
                                    className="w-full h-auto object-cover rounded-xl shadow-md border border-gray-50"
                                />
                            </div>
                        </div>
                    )}
