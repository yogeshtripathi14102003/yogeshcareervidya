...
/**
 * Colored dash + column title — matches screenshot exactly.
 *
 * SEO FIX: this is a decorative mega-menu column label ("Quick Links",
 * "Get in Touch", "Top Ranked", etc.), NOT a real content heading. It was
 * previously rendered as <h4>, but since Header renders on every page
 * BEFORE the page's own <h1>, these labels were always the first heading
 * SEO crawlers (Ahrefs, Google) encountered in the DOM — triggering a
 * "first heading is not H1" warning site-wide. Changed to a plain <p>
 * with a dedicated class so styling stays identical but it's no longer
 * part of the page's heading outline.
 */
function ColHeading({ children, color = "#04458b" }) {
  return (
    <div className="mega-col-heading">
