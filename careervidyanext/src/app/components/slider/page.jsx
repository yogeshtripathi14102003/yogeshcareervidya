...
export default function HeroSlider({ initialBanners = [] }) {
  ...
  if (loading) return (
    <div className="w-full">
      <div className="hidden md:block w-full aspect-[1920/823] bg-gray-200 animate-pulse" />
      <div className="block md:hidden w-full aspect-[768/400] bg-gray-200 animate-pulse" />
    </div>
  );
