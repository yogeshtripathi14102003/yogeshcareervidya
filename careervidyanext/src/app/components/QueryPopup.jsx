...
//       <div className="bg-white w-full md:w-[90%] max-w-3xl rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row relative animate-slideUpMobile md:animate-fadeIn">
//         {/* Left Blue Panel */}
//         <div className="bg-[#0096D6] text-white w-full md:w-1/3 p-6 flex flex-col justify-center items-center text-center">
//           <img src="/images/callcenter.png" alt="help" className="w-16 h-16 mb-4" />
