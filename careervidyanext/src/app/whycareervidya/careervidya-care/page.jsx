...
"use client";
  ...
  import { 
    ChevronRight, 
    LogIn, LayoutDashboard, ShieldCheck, Headphones
  } from 'lucide-react';
  import Header from "@/app/layout/Header";
  import Getintuch from "@/app/components/getintuch";
  import Footer from "@/app/layout/Footer";
  ...
  export default function CareerVidyaPage() {
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
        {[
          { img: "/images/REMINDER.png", text: "We remind you about exams and important dates." },
          { img: "/images/LMS.png", text: "We guide you through LMS access and usage." },
          { img: "/images/assingments.png", text: "We help you stay on track with assignments." },
          { img: "/images/connection.png", text: "We stay connected till the program is completed." }
        ].map((item, idx) => (
          <div key={idx} className="bg-white rounded-[30px] border border-blue-50 shadow-sm overflow-hidden flex flex-col h-full hover:shadow-lg transition-all duration-300">
            {/* Illustration Area */}
            <div className="p-3">
...
<section className="py-20 flex justify-center px-6 bg-white">
  ...
  */}
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
    {[
      { title: "Resume Builder", desc: "Build a resume that grabs attention and gets unlimited iterations.", icon: "/images/resume.png" },
      { title: "Mock Test", desc: "Practice real interview questions and polish your skills.", icon: "/images/mock.png" },
      { title: "Job Portal", desc: "Access relevant, verified job opportunities based on your degree.", icon: "/images/job.png" },
      { title: "Community Learning", desc: "Stay on track by learning with peers who have same goals.", icon: "/images/community.png" }
    ].map((card, i) => (
      <div 
        key={i} 
        className="relative bg-white rounded-2xl p-5 md:p-8 border border-gray-100 shadow-sm 
                   flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-0"
      >
        {/* Icon Circle - Smaller on mobile, original on desktop */}
        <div className="relative w-12 h-12 md:w-14 md:h-14 shrink-0 rounded-xl bg-blue-50 flex items-center justify-center md:mb-6 overflow-hidden">
          <Image
            src={card.icon}
            alt={card.title}
            fill
        ...
        <div className="flex flex-col">
          <h4 className="font-bold text-lg md:text-xl text-[#002B5B] mb-1 md:mb-4">
            {card.title}
          </h4>
          ...
          {/* Learn More - Hidden on mobile for cleaner 'List' look, visible on desktop */}
          <div className="hidden md:flex items-center text-[#007bff] font-bold text-sm mt-8 cursor-pointer">
            Learn more 
...
<section className="max-w-7xl mx-auto py-14 px-6 relative overflow-hidden">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
    ...
    <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
      {[
        { 
          icon: "/images/anti-overwhelm.png", 
          title: "Anti-Overwhelm", 
          desc: "We break complex mountains into manageable molehills.",
        },
        { 
          icon: "/images/seamless-flow.png", 
          title: "Seamless Flow", 
          desc: "Step-by-step walkthroughs instead of messy instructions.",
        },
        { 
          icon: "/images/proactive-nudges.png", 
          title: "Proactive Nudges", 
          desc: "Alerts before deadlines strike, keeping you ahead.",
        },
        { 
        ...
        >
          <div className={`relative w-12 h-12 ${item.color} rounded-xl flex items-center justify-center mb-6 overflow-hidden`}>
            <Image
              src={item.icon}
              alt={item.title}
              fill
          ...
          <h4 className="font-bold text-[#002B5B] text-lg mb-2">
            {item.title}
          </h4>
          <p className="text-slate-500 text-sm leading-relaxed">
            {item.desc}
