...
export default function BottomOfferBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-[999] bg-gradient-to-r from-[#FF671F] via-[#FFFFFF] to-[#046A38] border-t-2 border-[#000080]/30 shadow-[0_-5px_20px_rgba(0,0,0,0.3)] animate-in slide-in-from-bottom duration-500 hidden md:block">
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between min-h-[60px] md:min-h-[50px]">
        ...
        <div className="flex flex-wrap items-center justify-between w-full md:w-auto px-4 py-2 md:py-0 gap-4 flex-1">
          ...
          <button 
            onClick={() => setShow(false)} 
            className="text-slate-800/60 hover:text-slate-950 transition-colors order-first md:order-none cursor-pointer focus:outline-none"
            aria-label="Close banner"
          >
            <X size={18} />
          </button>

          {/* Text Content - High contrast for Tiranga Background */}
          <div className="flex flex-col items-center md:items-start gap-0.5 flex-1 md:flex-initial justify-center text-center md:text-left">
            <p className="text-[13px] md:text-sm font-bold text-slate-950 tracking-wide flex items-center gap-1.5 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
              <span>🎉 Special Tiranga Offer:</span>
              <span className="text-[#000080] font-black underline decoration-amber-500 decoration-2">Get 10% - 20% Discount</span>
            </p>
            <p className="text-[11px] md:text-xs text-slate-900 font-semibold flex items-center justify-center md:justify-start gap-1 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
              <span className="inline-flex bg-[#000080] p-0.5 rounded-sm shrink-0 items-center justify-center">
                <Gift size={10} className="text-amber-300" />
              </span>
              Applicable on <span className="text-[#000080] font-bold">Any Course Admission</span> (Free Career Counselling)
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="hover:scale-110 transition-transform cursor-pointer block drop-shadow-md"
            >
              <img 
                src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" 
                className="w-5 h-5" 
        ...
        {/* Right Side: Action Buttons in Ashok Chakra Navy Blue Theme */}
        <div className="flex items-stretch w-full md:w-auto border-t border-slate-300 md:border-t-0 self-stretch shrink-0">
          
          {/* Register Now Block Action */}
          <button
            onClick={() => router.push("/signup")}
            className="flex-1 md:flex-none bg-[#FF671F] hover:bg-[#e05510] text-white px-6 py-3 md:py-0 flex items-center justify-center font-bold text-sm transition-colors cursor-pointer border-r border-white/20 shadow-inner"
          >
            Enroll Now
          </button>
          ...
          <a
            href="tel:+9289716667"
            className="flex-1 md:flex-none bg-[#000080] hover:bg-[#000066] text-white px-6 py-3 md:py-0 flex items-center justify-center gap-2 font-semibold text-sm transition-colors border-r border-white/20 cursor-pointer"
          >
            <span>Call us now</span>
          </a>
          ...
          <a 
            href="tel:+919289716667"
            className="flex-1 md:flex-none bg-[#000080] hover:bg-[#000066] text-[#FF9933] px-6 py-3 md:py-0 flex items-center justify-center gap-2 font-bold text-sm tracking-wide transition-colors cursor-pointer"
          >
            <Phone size={14} className="fill-current text-[#FF9933]" />
            <span>9289716667</span>
          </a>
